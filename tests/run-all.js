...
const areas = ['onboarding', 'pedido', 'despacho', 'financeiro', 'seguranca', 'reputacao', 'lgpd', 'integracoes', 'admin', 'feira', 'pagamentos', 'repasses_automaticos', 'subcontas', 'webhook_asaas', 'vagas_entregador', 'despacho_motor'];
